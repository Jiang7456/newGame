...
public class CharIf01 {
    ...
    public static void charExtForIf2(String param, int x, int y) throws AWTException, IOException, URISyntaxException {
        ...
        Robot robot = new Robot();
        String str[] = {"财", "帛", "会", "禄", "禄", "存", "华", "盖", "智", "辩", "力", "量", "翻", "羽", "宗", "气", "孔", "武", "越", "影", "聪", "颖", "纳", "气", "蛮", "力", "奔", "宵", "聪", "慧", "铁", "骨", "延", "寿", "定", "慧", "默", "祷", "混", "茫", "混", "扰", "眩", "怖", "眩", "疑", "翱", "翔", "鸣", "响", "入", "定", "定", "然", "之", "咒", "强", "健", "吞", "焰",  "禁",  "无", "双", "无", "妄", "无", "量", "清", "逸", "清", "韵", "响", "朗", "驰", "骋", "翱", "翔", "眩", "疑", "眩", "怖", "默", "吟"};
        String str1[] = {"东", "皇", "钟"};
        //特殊的东皇垃圾钟
        String str4[] = {"智", "辩", "财", "帛", "会", "禄"};
        String params = param;
