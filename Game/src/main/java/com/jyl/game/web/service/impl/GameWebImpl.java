package com.jyl.game.web.service.impl;
...
import com.jyl.game.web.utils.thread.Example;
...
/**
 * @Auther: pc
 * @Date: 2019-08-18 11:29
 * @Description:
 */
@Service
public class GameWebImpl implements GameWeb {

    public GameResponse temp(GameRequest request) throws AWTException, IOException, URISyntaxException {
        String path = request.getPath();
        int x = request.getX();
        int y = request.getY();
        String ck = request.getCk();
...
//                    鼠标位置
    ...
    public GameResponse repo(int key) {
        return null;
    }

    public String test(GameRequest request,boolean temp) {
        return null;
    }
