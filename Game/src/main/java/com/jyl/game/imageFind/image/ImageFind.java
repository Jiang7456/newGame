package com.jyl.game.imageFind.image;
...
/**
 * @Auther: pc
 * @Date: 2019-08-29 00:24
 * @Description: 查找图片上的指定图片
 * 说明：比较两个像素点rgb值是否相同，如果异或操作后得到的值为0，说明两个像素点rgb一样，否则不一样
 * 原文链接：https://www.cnblogs.com/jebysun/p/3969352.html
 */
public class ImageFind {
    ...
    public static void main(String[] args) {
        String keyImagePath = "C:\\Users\\pc\\Desktop\\jpg\\111.png";
        ImageFind demo = new ImageFind(keyImagePath);
        demo.printFindData();
    }
}
